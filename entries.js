...
window.DICTIONARY_ENTRIES = [
  {
    id: "2026-06-03-sachiusui",
    word: "幸薄い",
    reading: "さちうすい",
    partOfSpeech: "形容詞",
    shortMeaning: "幸せに恵まれない様子。いかにも不幸そう・はかなげに見えること。",
    meaning: "幸運や幸福にあまり恵まれていないさま。また、容姿や雰囲気から、いかにも苦労していそう・不幸そうに見えることを表す。「幸（さいわい）が薄い」という形で、運に乏しい境遇を指す場合（「幸薄い人生」）と、はかなげで影のある見た目の印象を指す場合（「幸薄そうな顔」）の両方に使われる。「幸薄」「幸薄な」の形でも使われる。",
    examples: [
      "彼女はどこか幸薄い、はかなげな雰囲気をまとっていた。",
      "苦労が続き、幸薄い半生を送った。"
    ],
    trivia: "「幸（さち）」はもともと「山の幸・海の幸」のように自然の恵みや獲物を意味し、そこから「幸福・幸運」の意味に広がった言葉。「幸薄い」はその幸（さいわい）が薄い＝少ないことを表す。近年は、美人だが影のある容姿を「幸薄そう（な美人）」と形容する使い方も広まっている。",
    tags: ["形容詞", "心理", "感情"],
    isRealThing: false,
    image: null,
    imageCredit: "",
  ...
  },
  {
    ...
    reading: "かぶりをふる",
    partOfSpeech: "慣用句（連語）",
    shortMeaning: "頭を横に振って、否定・拒否の気持ちを表すこと。",
    meaning: "頭を左右に振って「いやだ」「違う」という否定や拒否の意思を示すこと。「かぶり」は頭（あたま）を指す古い言葉で、「かぶりを振る」は「首を横に振る」とほぼ同じ意味になる。承知しない、断る、認めない、といった場面の動作を表す慣用表現。",
    examples: [
      "何度頼んでも、彼はかぶりを振るばかりだった。",
      "提案を聞いた祖母は、静かにかぶりを振った。"
    ],
    trivia: "「かぶり」は頭を表す古語で、今では日常語としてはほとんど使われず、「かぶりを振る」というこの慣用句の中にだけ残っている。意味は「首を横に振る」と同じで、肯定の「うなずく」と対になる動作。",
    tags: ["慣用句", "古語", "動作"],
    isRealThing: false,
    image: null,
    imageCredit: "",
  ...
  },
  {
    ...
    reading: "せみしぐれ",
    partOfSpeech: "名詞",
    shortMeaning: "多くの蝉が一斉に鳴く声を、降りしきる時雨にたとえた言葉。",
    meaning: "たくさんの蝉が一斉に鳴き立て、その声がまるで時雨（しぐれ＝さっと降りすぎる雨）のように降りそそいで聞こえるさまを表す言葉。夏の盛りの情景を伝える表現で、俳句では夏の季語として使われる。降るような蝉の声と、やがて静まる無常感とがあいまって、季節の移ろいを感じさせる。",
    examples: [
      "境内に足を踏み入れると、降るような蝉しぐれに包まれた。",
      "蝉しぐれが最も激しくなる午後、木陰で涼を取った。"
    ],
    trivia: "「時雨（しぐれ）」はもともと晩秋から初冬にぱらぱらと降る通り雨のこと。その降りそそぐ音のイメージを、夏の蝉の大合唱に重ねた比喩表現。藤沢周平の時代小説『蝉しぐれ』の題名としても広く知られる。",
    tags: ["季語", "自然", "比喩"],
    isRealThing: false,
    image: null,
    imageCredit: "",
