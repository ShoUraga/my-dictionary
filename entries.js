...
window.DICTIONARY_ENTRIES = [
  {
    ...
    reading: "まくらぎ",
    partOfSpeech: "名詞",
    shortMeaning: "線路のレールを下から支えるため、横向きに敷き並べる角材（木材やコンクリート）。",
    meaning: "鉄道の線路で、2本のレールの下に一定間隔で横向きに敷かれ、レールを固定して支える部材。レール同士の間隔（軌間）を一定に保ち、列車の重みを砕石（バラスト）や地盤へ分散させる役割を持つ。古くは木製だったが、現在は耐久性の高いコンクリート製（PC枕木）が主流。役目を終えた古い木製の枕木は、庭の小道や花壇の縁取りなどガーデニングの資材として再利用されることも多い。",
    examples: [
      "線路の枕木が等間隔にずっと並んでいる。",
      "古い枕木を庭の小道に敷いて、味のあるアプローチにした。"
    ],
    trivia: "「枕木」の名は、レールを横たわる体に見立てたとき、その下を支える木が頭を乗せる「枕」のように見えることに由来するとされる。英語ではイギリスで sleeper（眠る人＝枕木）、アメリカで tie / crosstie と呼ぶ。",
    tags: ["鉄道", "建築", "専門用語"],
    isRealThing: true,
    image: null,
    imageCredit: "",
